(function () {
    ...
    var addBindings = function (element, bindingInfo, viewModel) {
        for (var binding in bindingInfo) {
            if (bindings[binding] && bindings[binding].init && !element.allreadyBound) {
    ...
    var bindings = {
        ...
        template: {
            init: function (element, propertyValue, viewModel, configuration) {
        ...
        foreach: {
            init: function (element, propertyValue, viewModel, propertyName) {
